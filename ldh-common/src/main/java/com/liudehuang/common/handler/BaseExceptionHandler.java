...
public class BaseExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    public LdhResponse handleFebsException(BusinessException e) {
        log.error("系统错误", e);
        return new LdhResponse().message(e.getMessage());
    }
    ...
    public LdhResponse handleConstraintViolationException(ConstraintViolationException e) {
        ...
        return new LdhResponse().message(message.toString());
    }
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public LdhResponse handleBindException(BindException e) {
        StringBuilder message = new StringBuilder();
